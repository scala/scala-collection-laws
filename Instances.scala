...
"Array[Int]" -> (Array[Int]((0 to 0): _*), classOf[collection.mutable.WrappedArray[Int]]),
...
"collection.immutable.Range" -> (((0 to 0): collection.immutable.Range ), classOf[collection.immutable.Range]),
