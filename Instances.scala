...
object Instances {
  ...
  val all = Map(
    ...
    "collection.mutable.IndexedSeqView[Int,collection.mutable.IndexedSeq[Int]]" -> (collection.mutable.IndexedSeq((0 to 0): _*).view, classOf[collection.mutable.IndexedSeqView[Int,collection.mutable.IndexedSeq[Int]]], mth(collection.mutable.IndexedSeq((0 to 0): _*).view)),
