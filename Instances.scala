...
object Instances {
  ...
  val all = Map(
    ...
    "collection.IterableView[Int,Iterable[Int]]Appended" -> (Iterable((0 to 0): _*).view.++(Iterable(50,51)), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.++(Iterable(50,51)))),
    "collection.IterableView[Int,Iterable[Int]]DroppedWhile" -> (Iterable((0 to 0): _*).view.dropWhile(_ < 2), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.dropWhile(_ < 2))),
    "collection.IterableView[Int,Iterable[Int]]Filtered" -> (Iterable((0 to 0): _*).view.filter(_ > 4), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.filter(_ > 4))),
    "collection.IterableView[Int,Iterable[Int]]FlatMapped" -> (Iterable((0 to 0): _*).view.flatMap(i => Iterable(i, i+2)), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.flatMap(i => Iterable(i, i+2)))),
    "collection.IterableView[Int,Iterable[Int]]Mapped" -> (Iterable((0 to 0): _*).view.map(_ + 1), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.map(_ + 1))),
    "collection.IterableView[Int,Iterable[Int]]Sliced" -> (Iterable((0 to 0): _*).view.drop(2), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.drop(2))),
    "collection.IterableView[Int,Iterable[Int]]TakenWhile" -> (Iterable((0 to 0): _*).view.takeWhile(_ < 6), classOf[collection.IterableView[Int,Iterable[Int]]], mth(Iterable((0 to 0): _*).view.takeWhile(_ < 6))),
    ...
    "collection.SeqView[Int,Seq[Int]]Appended" -> (Seq((0 to 0): _*).view.++(Seq(50,51)), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.++(Seq(50,51)))),
    "collection.SeqView[Int,Seq[Int]]DroppedWhile" -> (Seq((0 to 0): _*).view.dropWhile(_ < 2), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.dropWhile(_ < 2))),
    "collection.SeqView[Int,Seq[Int]]Filtered" -> (Seq((0 to 0): _*).view.filter(_ > 4), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.filter(_ > 4))),
    "collection.SeqView[Int,Seq[Int]]FlatMapped" -> (Seq((0 to 0): _*).view.flatMap(i => Seq(i, i+2)), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.flatMap(i => Seq(i, i+2)))),
    "collection.SeqView[Int,Seq[Int]]Mapped" -> (Seq((0 to 0): _*).view.map(_ + 1), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.map(_ + 1))),
    "collection.SeqView[Int,Seq[Int]]Patched" -> (Seq((0 to 0): _*).view.patch(1,Seq(50,51),1), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.patch(1,Seq(50,51),1))),
    "collection.SeqView[Int,Seq[Int]]Reversed" -> (Seq((0 to 0): _*).view.reverse, classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.reverse)),
    "collection.SeqView[Int,Seq[Int]]Sliced" -> (Seq((0 to 0): _*).view.drop(2), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.drop(2))),
    "collection.SeqView[Int,Seq[Int]]TakenWhile" -> (Seq((0 to 0): _*).view.takeWhile(_ < 6), classOf[collection.SeqView[Int,Seq[Int]]], mth(Seq((0 to 0): _*).view.takeWhile(_ < 6))),
    ...
    "collection.TraversableView[Int,Traversable[Int]]Appended" -> (Traversable((0 to 0): _*).view.++(Traversable(50,51)), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.++(Traversable(50,51)))),
    "collection.TraversableView[Int,Traversable[Int]]DroppedWhile" -> (Traversable((0 to 0): _*).view.dropWhile(_ < 2), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.dropWhile(_ < 2))),
    "collection.TraversableView[Int,Traversable[Int]]Filtered" -> (Traversable((0 to 0): _*).view.filter(_ > 4), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.filter(_ > 4))),
    "collection.TraversableView[Int,Traversable[Int]]FlatMapped" -> (Traversable((0 to 0): _*).view.flatMap(i => Traversable(i, i+2)), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.flatMap(i => Traversable(i, i+2)))),
    "collection.TraversableView[Int,Traversable[Int]]Mapped" -> (Traversable((0 to 0): _*).view.map(_ + 1), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.map(_ + 1))),
    "collection.TraversableView[Int,Traversable[Int]]Sliced" -> (Traversable((0 to 0): _*).view.drop(2), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.drop(2))),
    "collection.TraversableView[Int,Traversable[Int]]TakenWhile" -> (Traversable((0 to 0): _*).view.takeWhile(_ < 6), classOf[collection.TraversableView[Int,Traversable[Int]]], mth(Traversable((0 to 0): _*).view.takeWhile(_ < 6))),
    ...
    "collection.immutable.StreamView[Int,Stream[Int]]Appended" -> (Stream((0 to 0): _*).view.++(Stream(50,51)), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.++(Stream(50,51)))),
    "collection.immutable.StreamView[Int,Stream[Int]]DroppedWhile" -> (Stream((0 to 0): _*).view.dropWhile(_ < 2), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.dropWhile(_ < 2))),
    "collection.immutable.StreamView[Int,Stream[Int]]Filtered" -> (Stream((0 to 0): _*).view.filter(_ > 4), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.filter(_ > 4))),
    "collection.immutable.StreamView[Int,Stream[Int]]FlatMapped" -> (Stream((0 to 0): _*).view.flatMap(i => Stream(i, i+2)), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.flatMap(i => Stream(i, i+2)))),
    "collection.immutable.StreamView[Int,Stream[Int]]Mapped" -> (Stream((0 to 0): _*).view.map(_ + 1), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.map(_ + 1))),
    "collection.immutable.StreamView[Int,Stream[Int]]Patched" -> (Stream((0 to 0): _*).view.patch(1,Stream(50,51),1), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.patch(1,Stream(50,51),1))),
    "collection.immutable.StreamView[Int,Stream[Int]]Reversed" -> (Stream((0 to 0): _*).view.reverse, classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.reverse)),
    "collection.immutable.StreamView[Int,Stream[Int]]Sliced" -> (Stream((0 to 0): _*).view.drop(2), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.drop(2))),
    "collection.immutable.StreamView[Int,Stream[Int]]TakenWhile" -> (Stream((0 to 0): _*).view.takeWhile(_ < 6), classOf[collection.immutable.StreamView[Int,Stream[Int]]], mth(Stream((0 to 0): _*).view.takeWhile(_ < 6))),
